...
Panoptes has a baked-in database of icons and plug data built specifically for Shadowkeep build 86657.20.08.23, and will not function on any newer versions of the game. It is only tested to be compatible with Project Sunrise 0.2.1, and may become incompatible with future versions due to schema changes with the settings.json file that Sunrise uses to assign loadouts.
